...
abstract class $GenreCopyWith<$Res> {
  ...
  @useResult
  $Res call({int? id, String? name, bool? selected});
}
...
class _$GenreImpl implements _Genre {
  _$GenreImpl({this.id, this.name, this.selected = false});
  ...
  @override
  String toString() {
    return 'Genre(id: $id, name: $name, selected: $selected)';
  }
...
abstract class _Genre implements Genre {
  factory _Genre({int? id, String? name, bool? selected}) = _$GenreImpl;
